...
class PunchCounter:
    ...
    def __init__(self, pose_detector):
        ...
        self.total_count = 0
        self.punch_counts = {self.JAB: 0, self.CROSS: 0, self.HOOK: 0, self.UPPERCUT: 0}
        ...
        self.calibration_data = {"velocity_multiplier": 1.0, "direction_adjust": 0.0}
    ...
    def detect_punches(self, keypoints_list):
        ...
        for hand, wrist_key in [("left", "left_wrist"), ("right", "right_wrist")]:
            ...
            velocity, direction = self._calculate_velocity(
                self.position_history[wrist_key], self.timestamp_history[wrist_key]
            )
            ...
            if self._is_punch_motion(velocity, direction, hand):
                ...
                print(
                    f"Detected {punch_type.upper()} - Total punches: {self.total_count}"
                )
